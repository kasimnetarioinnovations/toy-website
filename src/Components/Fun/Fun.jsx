...
const Fun = () => {
  return (
    <div className='container-fluid fun d-none d-md-block'>
          <div className="row align-items-center">
              <div className="col-12 col-md-5">
                  <div>
                      <h1 className='fun-heading'>Endless Fun with Every <span className='toy' style={{  fontFamily: "Matemasie", fontWeight: '400', fontStyle: 'normal'}}>Toy </span> Adventure!</h1>
                      <Button variant="" className="text-white btn-funn ">
                  Shop Now
                </Button>
                </div>
              </div>
          ...
          <div className='d-flex align-items-center justify-content-around d-none d-md-flex duck-card '>
            ...
            <div className='toy-card'>
              ...
              <img src={Duck} alt="" className='duck-img' />
              </div>
              <div className=''>
                {/* 1st div */}
              ...
              <div className='d-flex mt-2 gap-2'>
                <p><TbRulerMeasure2 style={{fontSize:'30px', fontWeight:'300', color:'#000'}}/></p>
                <div className='d-flex flex-column' style={{ color: '#afb0b1' }}>
                  <p>Level</p>
            ...
            <div className='toy-card'>
              <div  className='d-flex align-items-center justify-content-center'>
              <img src={Truck} alt="duck" className='duck-img' />
              </div>
              <div className=''>
                {/* 1st div */}
                <div className='d-flex align-items-center justify-content-between '>
            ...
            <div className='toy-card'>
              <div  className='d-flex align-items-center justify-content-center'>
              <img src={Truck1} alt="duck" className='duck-img' />
              </div>
              <div className=''>
                {/* 1st div */}
                <div className='d-flex align-items-center justify-content-between '>
